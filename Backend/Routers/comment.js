...
const { addNewCommentToStory ,getAllCommentByStory,commentLike ,getCommentLikeStatus, deleteCommentByAuthor} = require("../Controllers/comment")
...
router.delete("/:comment_id",deleteCommentByAuthor)
